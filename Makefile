...
no-default:
	@echo "There is no default target. Please choose one of the following targets:"
	@echo "    build, install, clean, check, git-hooks-install"
	@exit 1
...
.PHONY: no-default build install clean check-git check-python check git-hooks-install
